...
chrome.webRequest.onBeforeSendHeaders.addListener(
    ...
    if(details.url=="https://api.streak.tech/notifications_handler/"){
            ...
            if ((details.initiator=="https://streak.angelbroking.com"||details.initiator=="https://streakv3.zerodha.com"||details.initiator=="https://streak.zerodha.com") && fetching_notif!=true){
                try{
                    fetch_notifications(details.url,details.requestHeaders);
                }catch(err) {
                }
            }
        }
